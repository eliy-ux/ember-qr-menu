...
$("#year").textContent = new Date().getFullYear(); $("#qrBaseUrl").value = new URL("index.html", window.location.href).href; renderOrders(); renderMenuItems(); renderServiceRequests(); setTimeout(() => { if (!auth.currentUser && !$("#loginModal").open) $("#loginModal").showModal(); }, 500);
